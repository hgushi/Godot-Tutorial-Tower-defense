...
func _on_Tutorial_button_down():
	var erro = get_tree().change_scene("res://Scenes/ArenaTeste/TutorialLevel.tscn")
...
func _on_Level1_button_down():
	var erro = get_tree().change_scene("res://Scenes/ArenaTeste/Level_2.tscn")
	if (erro == ERR_CANT_OPEN):
		print("não consegui abrir")
	elif (erro == ERR_CANT_CREATE):
		print("não consegui instancia")
...
func _on_Level2_button_down():
	var erro = get_tree().change_scene("res://Scenes/ArenaTeste/Level_3.tscn")
	if (erro == ERR_CANT_OPEN):
		print("não consegui abrir")
	elif (erro == ERR_CANT_CREATE):
		print("não consegui instancia")
